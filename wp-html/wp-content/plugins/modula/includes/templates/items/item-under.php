<div class="<?php echo esc_attr( implode( ' ', $data->item_classes ) ) ?> modula-caption-effect-item"<?php echo Modula_Helper::generate_attributes( $data->item_attributes ) ?> >
    ...
    <?php if ( 'no-link' != $data->lightbox ): ?>
        <a<?php echo Modula_Helper::generate_attributes( $data->link_attributes ) ?>
                class="<?php echo esc_attr( implode( ' ', $data->link_classes ) ) ?>"></a>
    <?php endif ?>
